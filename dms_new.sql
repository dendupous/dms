...
CREATE TABLE `app_dispatch_actions`  (
  ...
  `remarks` longvarchar CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `sms_log`  (
  ...
  `sms` varchar CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `sys_departments`  (
  ...
  `description` longvarchar CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `author` int(11) NOT NULL,
  `created` datetime(0) NOT NULL,
  `modified` datetime(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `sys_dispatch_status`  (
  ...
  `description` tinyvarchar CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL,
