				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="page-header">
							<h1>Recieve<small><i class="ace-icon fa fa-angle-double-right"></i> Reciept Official Letters</small></h1>
						</div><!-- /.page-header -->
						<?php	
							$year = date('Y');
							$drNumber = $generalClass->getDispatchNum('dr_num', $year, 2); 
								...
								<div class="row">
									<form class="form-horizontal" action="../includes/process.php" method="post"  id="genericFormForAll" enctype="multipart/form-data">
											...
											<div class="form-group"> 
												...
												<div class="col-sm-6 col-md-7 col-lg-8 selectContainer">
													<div class="input-group">
														...
														<input type="text" name="doffice" id="doffice" placeholder="From: Name of Ministry/Agency/Office" class="form-control"/>
													</div>
												</div>
											</div>
											<div class="form-group"> 
												...
												<div class="col-sm-6 col-md-7 col-lg-8 selectContainer">
													<div class="input-group">
														...
														<input type="text" name="dodept" id="dodept" placeholder="From: Name of Dept/Agency/Office" class="form-control" />
													</div>
												</div>
											</div>
											<div class="form-group"> 
												...
												<div class="col-sm-6 col-md-7 col-lg-8 selectContainer">
													<div class="input-group">
														...
														<input type="text" name="dodivision" id="dodivision" placeholder="From: Name of Division/Agency/Office" class="form-control" />
													</div>
												</div>
											</div>
											<div class="form-group"> 
												<label class="col-sm-6 col-md-5 col-lg-3 control-label">Source (Place)</label>
												<div class="col-sm-6 col-md-7 col-lg-8 selectContainer">
													<div class="input-group">
														<span class="input-group-addon"><i class="ace-icon fa fa-map-marker"></i></span>
														<input type="text" name="doplace" id="doplace" placeholder="From: Place" class="form-control" required />
													</div>
												</div>
											</div>
											<div class="form-group"> 
										...
										<fieldset>
											...
											<div class="form-group"> 
												<label class="col-sm-6 col-md-5 col-lg-3 control-label">Letter Address To</label>
												<div class="col-sm-6 col-md-7 col-lg-8 selectContainer">
													<div class="input-group">
												...
												<div class="col-sm-6 col-md-7 col-lg-8 selectContainer">
													<div class="input-group">
														...
														<select name="adepartment" id="adepartment" class="form-control selectpicker" required>
															...
															?>
															<option value="<?php echo $dDtls['id']."/".$userDetails->division;?>"><?php echo $dDtls['name']." - ".$dDtls['description']; ?></option>
															<?php endforeach; ?>
														</select>
													</div>
												</div>
											...
											<div class="form-group"> 
												<label class="col-sm-6 col-md-5 col-lg-3 control-label">Dak Number</label>
												<div class="col-sm-6 col-md-7 col-lg-8 selectContainer">
													<div class="input-group">
