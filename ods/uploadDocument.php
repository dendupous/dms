	...
	<form class="form-horizontal" action="../includes/process.php" method="post"  id="genericFormForAll" enctype="multipart/form-data">
		<fieldset>
			<div class="form-group"> 
				<input type="file" name="recDocument" id="recDocument" class="btn btn-primary" required/>
			</div>
			<div class="form-group"> 
				...
				<div class="col-sm-9 col-md-8 col-lg-10">
					<div class="pull-right">
						...
						<button type="submit" class="btn btn-success" name="uploadReceiptDocument">Upload File <span class="glyphicon glyphicon-ok"></span></button>
					</div>
				</div>
			</div>
		</fieldset>
