							...
							<form class="form-horizontal" action="../includes/process.php" method="post" id="loginForm">
								<div class="form-group">
									<div class="col-md-12  inputGroupContainer">
										...
										<input  id="userNameInput" name="userNameInput" placeholder="Enter Username &raquo; Email or Mobile Number" class="form-control"  type="text">
									</div>
									</div>
								</div>
								<div class="form-group has-feedback">
									<div class="col-md-12  inputGroupContainer">
										<div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
											<input class="form-control" id="userPassInput" type="password" placeholder="Enter Password &raquo; Your password for DMS"  name="userPassInput" required />
								...
								<div class="form-group">
									<div class="col-md-12">
										<button type="submit" name="loginSubmit" class="btn btn-warning btn-block" >Login <span class="glyphicon glyphicon-send"></span></button>
									</div>
								</div>
								
								<div class="form-group">
									<div class="col-md-12">
										<div class="right"><a href="resetpassword.php">Forgot Password?</a></div>
									</div>
								</div>
							</form>
						</div>
