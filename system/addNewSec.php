			...
			<div class="form-group">
				...
				<div class="col-sm-9 col-md-7 col-lg-9 inputGroupContainer">
					<div class="input-group">
						...
						<input name="section" id="section" placeholder="Section Name" class="form-control" type="text" required onkeydown="return (event.keyCode!=13);" />
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9 col-md-7 col-lg-9 inputGroupContainer">
					<div class="input-group">
						...
						<input name="sdesc" id="sdesc" placeholder="Section Description" class="form-control" type="text" required onkeydown="return (event.keyCode!=13);" />
					</div>
				</div>
			</div>
			<div class="form-group"> 
				...
				<div class="col-sm-9 col-md-7 col-lg-9">
					<div class="pull-right">
						...
						<button type="submit" class="btn btn-success" name="addNewSec">Add Section <span class="glyphicon glyphicon-ok"></span></button>
					</div>
				</div>
			</div>
		</fieldset>
