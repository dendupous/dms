							...
							<div class="col-xs-12">
								<div class="tabbable">
									<ul class="nav nav-tabs padding-18 tab-size-bigger" id="myTab">
										<li class="active"><a href="office.php"><i class="blue ace-icon fa fa-bank bigger-120"></i>Office</a></li>
									...
									<div class="tab-content no-border padding-24">
										<div class="tab-pane fade in active">
											<h3 class="blue">Office Details</h3>
											<div class="clearfix">
												<div class="pull-right">
													<a href="addNewOffice.php" type="button" class="addDeptModal btn btn-success">Add New <i class="ace-icon fa fa-plus"></i></a></div>
											</div>
											...
											<div>
												<table id="dynamic-table" class="table table-striped table-bordered table-hover">
													...
													<tbody>
														<?php 
															$offices = $generalClass->getAll(TBL_OFFICE); 
															$sl = 1;
														...
														<tr>
															...
															<td>
																<div class="action-buttons">
																	<a class="green editDeptModal" href="editOffice.php?id=<?php echo $office['id']; ?>" title="Edit Office Detail.">
																		<i class="ace-icon fa fa-pencil bigger-130"></i>
																	</a>
																	<a class="red" href="deleteOffice.php?id=<?php echo $office['id']; ?>" onclick="return confirm('Are you sure you want to delete?')" title="Delete Office Detail.">
